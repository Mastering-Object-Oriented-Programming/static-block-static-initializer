...
public class Employee {
    ...
    final static String COMPANY_NAME = "TrainingMug"; // class variable ( class specific )

    final static String COMPANY_CONTACT_NO = "34534534";

    final static String COMPANY_CEO = "Steve";
    ...
    static void companyInfo(){
        ...
        System.out.println("Company Contact No : " + COMPANY_CONTACT_NO);
